...
for(var i = 0; i < 10; i++)
{
	if( i = 0)
	{
		...
		draw_set_font(Font1);
		draw_text( board_x + left_offset , board_y + 93 + line_space, string(i + 1));
		draw_set_halign(fa_left);
		draw_text( board_x + 180 + 80 , board_y + 93 + line_space, string( global.scores[i] ));
		line_space += font_get_size(Font1) * 1.3;
	...
	else
	{
		...
		draw_set_halign(fa_left);
		draw_text( board_x + 180 + 80 , board_y + 95 + line_space, string( global.scores[i] ));
		line_space += font_get_size(Font3) * 1.9;
	}
